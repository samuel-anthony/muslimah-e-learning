                        ...
                        @else
                            ...
                            @csrf
                                ...
                                <div class="form-group row">
                                    <label for="pilihan1" class="col-3 inputRequired">Pilihan A*</label>
                                    <div class="col-1">:</div>
                                    <input type="text" class="form-control col-7" id="pilihan1" placeholder="Enter Selection" name="jawaban_a" required value="{{$soals[$soalKe-1]->jawaban_a}}">
                                </div>
                                <div class="form-group row">
                                    <label for="pilihan2" class="col-3 inputRequired">Pilihan B*</label>
                                    <div class="col-1">:</div>
                                    <input type="text" class="form-control col-7" id="pilihan2" placeholder="Enter Selection" name="jawaban_b" required value="{{$soals[$soalKe-1]->jawaban_b}}">
                                </div>
                                <div class="form-group row">
                                    <label for="pilihan3" class="col-3 inputRequired">Pilihan C*</label>
                                    <div class="col-1">:</div>
                                    <input type="text" class="form-control col-7" id="pilihan3" placeholder="Enter Selection" name="jawaban_c" required value="{{$soals[$soalKe-1]->jawaban_c}}">
                                </div>
                                <div class="form-group row">
                                    <label for="pilihan4" class="col-3 inputRequired">Pilihan D*</label>
                                    <div class="col-1">:</div>
                                    <input type="text" class="form-control col-7" id="pilihan4" placeholder="Enter Selection" name="jawaban_d" required value="{{$soals[$soalKe-1]->jawaban_d}}">
                                </div>
                                <div class="form-group row">
                                    <label for="answer" class="col-3 inputRequired">Jawaban*</label>
                                    <div class="col-1">:</div>
